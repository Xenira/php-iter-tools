...
class RSTest extends TestCase
{
    ...
    {
        $this->assertEquals(-1, $this->iterator->cmp(\ArrayIter::new([1, 2, 3, 4, 6])));
    ...
    {
        $this->assertEquals(-1, $this->iterator->partialCmp(\ArrayIter::new([1, 2, 3, 4, 6])));
    ...
    {
        $this->assertTrue($this->iterator->eq(\ArrayIter::new([1, 2, 3, 4, 5])));
        $this->assertFalse(\ArrayIter::new([1, 2, 3, 4, 5])->eq(\ArrayIter::new([1, 2, 3, 4, 6])));
    }

    public function testNe(): void
    {
        $this->assertTrue($this->iterator->ne(\ArrayIter::new([1, 2, 3, 4, 6])));
        $this->assertFalse(\ArrayIter::new([1, 2, 3, 4, 5])->ne(\ArrayIter::new([1, 2, 3, 4, 5])));
    }

    public function testLt(): void
    {
        $this->assertTrue($this->iterator->lt(\ArrayIter::new([1, 2, 3, 4, 6])));
    ...
    {
        $this->assertTrue($this->iterator->le(\ArrayIter::new([1, 2, 3, 4, 6])));
    ...
    {
        $this->assertFalse($this->iterator->gt(\ArrayIter::new([1, 2, 3, 4, 6])));
    ...
    {
        $this->assertFalse($this->iterator->ge(\ArrayIter::new([1, 2, 3, 4, 6])));
